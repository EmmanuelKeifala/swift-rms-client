...
export const PERMISSIONS = {
  ...
  REFERRALS_VIEW: ['PHU_STAFF', 'HOSPITAL_DESK', 'REFERRAL_COORDINATOR', 'SPECIALIST', 'DISTRICT_HEALTH', 'NATIONAL_USER', 'SYSTEM_ADMIN'] as UserType[],
  REFERRALS_CREATE: ['PHU_STAFF', 'HOSPITAL_DESK', 'REFERRAL_COORDINATOR', 'AMBULANCE_DISPATCH', 'SYSTEM_ADMIN'] as UserType[],
  REFERRALS_ACCEPT_REJECT: ['HOSPITAL_DESK', 'REFERRAL_COORDINATOR', 'SYSTEM_ADMIN'] as UserType[],
  ...
  // Readiness - Facility level users
  READINESS_VIEW: ['HOSPITAL_DESK', 'REFERRAL_COORDINATOR', 'DISTRICT_HEALTH', 'NATIONAL_USER', 'SYSTEM_ADMIN'] as UserType[],
